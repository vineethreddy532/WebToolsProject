...
public class CartDAO extends DAO {
	...
	public void updateCheckedProduct(String name, String price, String location, User u) {
		try {
			...
			Query q = getSession().createQuery(
					"from Product where productName = :productName and price=:price and prodLocation=:prodLocation");
	...
	public void updateRemovedProduct(String name, String price, String location, User u) {
		try {
			begin();
			Query q = getSession().createQuery(
					"from Product where productName = :productName and price=:price and prodLocation=:prodLocation");
